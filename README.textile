...
<script src="//webmap3.map.bdimg.com/yyfm/tinyDialog/1.0.0/js/tinyDialog.min.js"></script>
</pre>
另外我们还提供了预设的样式，也请同时引入，建议置于 @head@ 内

<pre><link rel="stylesheet" href="tinyDialog.min.css" />
<!-- 可以使用我们提供的CDN服务器 -->
<link rel="stylesheet" href="//webmap3.map.bdimg.com/yyfm/tinyDialog/1.0.0/css/tinyDialog.min.css" /></pre>
...
<pre>var myMiniDialog = tinyDialog({
